### REPLACE project_82 with the name you like
...
ARG USER_ID=1000
RUN useradd -m --no-log-init --system  --uid ${USER_ID} project_82 -g sudo
RUN echo '%sudo ALL=(ALL) NOPASSWD:ALL' >> /etc/sudoers
USER project_82
WORKDIR /home/project_82

ENV PATH="/home/project_82/.local/bin:${PATH}"
